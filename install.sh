...
echo ""
echo -e "${YELLOW}⚠️  [단축키 충돌 확인] Alt+방향키를 tmux pane 이동에 사용합니다.${NC}"
echo "   아래 설정과 충돌하지 않는지 확인하세요:"
echo "   - GNOME: Settings > Keyboard Shortcuts에서 Alt+방향키 검색"
echo "   - Terminator: Preferences > Keybindings에서 확인"
echo "   - 기타 터미널 에뮬레이터 keybinding 설정"
echo ""
echo "단축키 요약:"
echo "  Prefix       : Ctrl+Space"
echo "  Pane 이동    : Alt+방향키"
...
echo "  - Taeyoung96/tmux-agent-pulse  (AI CLI 상태 표시: Claude Code / Codex / Hermes)"
